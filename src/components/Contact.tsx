...
const Contact = () => {
  return (
    <section id="contact" className="section-padding bg-gradient-to-br from-white via-blue-50/40 to-green-50/40 relative overflow-hidden">
      ...
      <div className="container-custom relative">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Have questions about our counselling services? Reach out through any of these channels — we typically respond within hours.
          </p>
        </div>
